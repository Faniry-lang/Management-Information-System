<div class="popup popIn fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2/3 h-5/6 z-1000 rounded-2xl md:w-1/3 p-5 md:px-15 md:py-5 flex flex-col bg-white justify-around shadow-xl">
    ...
    <h2 class="text-3xl md:text-3xl font-semibold text-gray-800">Ajouter un nouveau type de recettes</h2>
    <form action="/dashboard/budget/nouveau-type-recette" method="post" class="flex flex-col gap-8">
        <div class="flex flex-col gap-3">
            <div class="flex flex-col gap-2">
                <label for="nom_type_recette" class="text-md font-semibold font-mono text-gray-700">Nom du type de la recette</label>
                <input type="text" name="nom_type_recette" id="nom_type_recette" class="px-5 py-1 border-2 border-gray-700 rounded-lg">
            </div>
        </div>
