<div class="w-full h-fit flex flex-row justify-end gap-5 px-5 py-2 shadow-2xl shadow-gray-200">
    <div class="flex flex-row gap-3">
        ...
        <div class="flex flex-row gap-2 px-5 py-1 border-l-1 border-gray-800">
            <h3 class="text-sm font-semibold text-gray-900">Gestion de budget</h3>
        </div>
    </div>
</div>
